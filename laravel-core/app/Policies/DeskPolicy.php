...
class DeskPolicy
{
    ...
    {
        return $user->Has_Permission('desks_consult');
    }
    ...
    {
        return $user->Has_Permission('desks_create');
    }
    ...
    {
        return $user->Has_Permission('desks_edit');
    }
    ...
    {
        return $user->Has_Permission('desks_delete');
    }
