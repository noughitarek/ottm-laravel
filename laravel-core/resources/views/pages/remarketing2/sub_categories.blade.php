      ...
      <table class="table table-hover my-0">
        <thead>
          <tr>
            ...
            <th class="d-xl-table-cell">Remarketings</th>
            <th>Action</th>
          </tr>
        </thead>
        <tbody>
            ...
            <tr>
                <td class="d-xl-table-cell">
                    <a href="{{route('remarketing_interval_sub_category', $category->id)}}" >
                ...
                <td>
                  @foreach($category->Remarketings_Interval() as $remarketing)
                    <i class="align-middle me-2 fas fa-fw fa-file"></i>{{$remarketing->name}}<br>
                  @endforeach
                </td>
                <td>
